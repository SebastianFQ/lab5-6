...
System.out.println(principal.showBuildingL(nombreComy,nameEmple));
  ...
  public void init(){
    ...
    Company techno = new TechnologyCompany("UbisoftSoftware","000000","ALAMEDA","3122690025",12,139.1,"2019-03-01", Company.SECURE_INMU_COM, "Bugisoft",jh, TechnologyCompany.SOFTWARE_DEVELOP,1333);
    principal.addCompany(techno);


    Building jotaMario = new Building(7);
    Company invi = new Invima("UbisoftSoftware1","000000","ALAMEDA","3122690025",12,139.1,"2019-03-01", Company.SECURE_INMU_COM, "Bugisoft",jotaMario,"sadasdasd",Invima.VALID,"2019-02-03",Invima.FABRICATION_SELL);
